...
<Tip type="warning">
  On occasion, the devkit may fail to generate icons or will cause an error in Storybook. If this happens, try running `yarn gen:icons` manually and restarting Storybook.
</Tip>
...
<Tip type="danger">
Icons that do not follow these guidelines may cause issues when generating the icon library and/or may not display correctly in the UI.
</Tip>
